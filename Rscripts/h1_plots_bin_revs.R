...
#pdf(paste0(outfol,"plots_review/figureS71.pdf"), height=8, width=7)
...
points(x=c(mstats2$lower66, mstats2$upper66),y=c(-0.06,-0.06), type='l', lwd=4, col=scales::alpha("#618b44",0.75))
points(x=c(mstats2$lower95, mstats2$upper95),y=c(-0.06,-0.06), type='l', lwd=2, col=scales::alpha("#618b44",0.75))
points(x=mstats2$mean,y=c(-0.06), pch=18,  col="#618b44",cex=2)
points(x=c(mstats1$lower66, mstats1$upper66),y=c(-0.03,-0.03), type='l', lwd=4, col=scales::alpha("#eda31d",0.75))
points(x=c(mstats1$lower95, mstats1$upper95),y=c(-0.03,-0.03), type='l', lwd=2, col=scales::alpha("#eda31d",0.75))
points(x=mstats1$mean,y=c(-0.03), pch=18,  col="#eda31d",cex=2)
...
mstats3 <- mediqr2 (res$b_PolC_Alcohol1)
...
mstats4 <- mediqr2 (res$b_PolC_Alcohol1)
...
points(x=c(mstats4$lower66, mstats4$upper66),y=c(-0.06,-0.06), type='l', lwd=4, col=scales::alpha("#618b44",0.75))
points(x=c(mstats4$lower95, mstats4$upper95),y=c(-0.06,-0.06), type='l', lwd=2, col=scales::alpha("#618b44",0.75))
points(x=mstats4$mean,y=c(-0.06), pch=18,  col="#618b44",cex=2)
points(x=c(mstats3$lower66, mstats3$upper66),y=c(-0.03,-0.03), type='l', lwd=4, col=scales::alpha("#eda31d",0.75))
points(x=c(mstats3$lower95, mstats3$upper95),y=c(-0.03,-0.03), type='l', lwd=2, col=scales::alpha("#eda31d",0.75))
points(x=mstats3$mean,y=c(-0.03), pch=18,  col="#eda31d",cex=2)
...
#########################
#### alcohol comparison # conservative EXT DATA fig s7
#########################
...
#pdf(paste0(outfol,"plots_review/figureS72.pdf"), height=8, width=7)
par(mfrow=c(2,1), mar=c(3,3,1.5,0),xpd=T)
