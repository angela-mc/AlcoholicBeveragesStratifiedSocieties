...
#########################
#### all models alcohol # compare conservative and wide data - for main figure 2
#########################
...
#pdf(paste0(outfol,"plots/alcohol_onPC_allmodels_CvsW.pdf"), height=10, width=9)
...
points(x=c(mstats2[2], mstats2[3]),y=c(-0.07,-0.07),  type='l', lwd=4, col=scales::alpha("#eda31d",0.75))
points(x=mstats2[1],y=c(-0.07), pch=18,  col="#eda31d",cex=2)
points(x=c(mstats1[2], mstats1[3]),y=c(-0.2,-0.2),type='l', lwd=4, col=scales::alpha("#009dc8",0.75))
points(x=mstats1[1],y=c(-0.2), pch=18,  col="#009dc8",cex=2)
...
points(x=c(mstats2[2], mstats2[3]),y=c(-0.05,-0.05), type='l', lwd=4, col=scales::alpha("#eda31d",0.75))
points(x=mstats2[1],y=c(-0.05), pch=18,  col="#eda31d",cex=2)
points(x=c(mstats1[2], mstats1[3]),y=c(-0.143,-0.143), type='l', lwd=4, col=scales::alpha("#009dc8",0.75))
points(x=mstats1[1],y=c(-0.143), pch=18,  col="#009dc8",cex=2)
...
points(x=c(mstats2[2], mstats2[3]),y=c(-0.045,-0.045), type='l', lwd=4, col=scales::alpha("#eda31d",0.75))
points(x=mstats2[1],y=c(-0.045), pch=18,  col="#eda31d",cex=2)
points(x=c(mstats1[2], mstats1[3]),y=c(-0.125,-0.125), type='l', lwd=4, col=scales::alpha("#009dc8",0.75))
points(x=mstats1[1],y=c(-0.125), pch=18,  col="#009dc8",cex=2)
#mtext(side=3,adj=0,text=paste0("Model 3", "\n", "Political complexity ~ Alcohol", "\n","+ env-productivity", "\n", "phylo-space"), line=-1, font=2)
#mtext(side=3,adj=0,text=paste0("Model 3", "\n", "Political complexity ~ Alcohol","+ env-productivity", "\n", "phylo-space"), line=-1, font=2)
...
points(x=c(mstats2[2], mstats2[3]),y=c(-0.045,-0.045), type='l', lwd=4, col=scales::alpha("#eda31d",0.75))
points(x=mstats2[1],y=c(-0.045), pch=18,  col="#eda31d",cex=2)
points(x=c(mstats1[2], mstats1[3]),y=c(-0.13,-0.13), type='l', lwd=4, col=scales::alpha("#009dc8",0.75))
points(x=mstats1[1],y=c(-0.13), pch=18,  col="#009dc8",cex=2)
#mtext(side=3,adj=0,text=paste0("Model 4", "\n", "Political complexity ~ Alcohol", "\n", "+ Agriculture", "\n", "phylo-space"), line=-1, font=2)
#mtext(side=3,adj=0,text=paste0("Model 4", "\n", "Political complexity ~ Alcohol", "+ Agriculture", "\n", "phylo-space"), line=-1, font=2)
...
points(x=c(mstats2[2], mstats2[3]),y=c(-0.06,-0.06), type='l', lwd=4, col=scales::alpha("#eda31d",0.75))
points(x=mstats2[1],y=c(-0.06), pch=18,  col="#eda31d",cex=2)
points(x=c(mstats1[2], mstats1[3]),y=c(-0.15,-0.15), type='l', lwd=4, col=scales::alpha("#009dc8",0.75))
points(x=mstats1[1],y=c(-0.15), pch=18,  col="#009dc8",cex=2)
#mtext(side=3,adj=0,text=paste0("Model 5", "\n", "Political complexity ~ Alcohol","\n", "+ Agriculture + env-productivity", "\n", "phylo-space"), line=-1, font=2)
#mtext(side=3,adj=0,text=paste0("Model 5", "\n", "Political complexity ~ Alcohol", "+ Agriculture + env-productivity", "\n", "phylo-space"), line=-1, font=2)
...
#pdf(paste0(outfol,"plots/agriculture_onPC_unmediated_CvsW.pdf"), height=8, width=7)
...
points(x=c(mstats2[2], mstats2[3]),y=c(-0.03,-0.03), type='l', lwd=4, col=scales::alpha("#eda31d",0.75))
points(x=mstats2[1],y=c(-0.03), pch=18,  col="#eda31d",cex=2)
points(x=c(mstats1[2], mstats1[3]),y=c(-0.06,-0.06), type='l', lwd=4, col=scales::alpha("#009dc8",0.75))
points(x=mstats1[1],y=c(-0.06), pch=18,  col="#009dc8",cex=2)
# mtext(side=3,adj=0,text=paste0("Model4(2)","\n", "PC ~ Agri", "\n", "phylo-space"), line=-2, font=2)
# mtext(side=3,adj=0,text=paste0("","\n", "PC ~ Agriculture", "\n", "phylo-space"), line=-2, font=1) 
...
points(x=c(mstats2[2], mstats2[3]),y=c(-0.02,-0.02), type='l', lwd=4, col=scales::alpha("#eda31d",0.75))
points(x=mstats2[1],y=c(-0.02), pch=18,  col="#eda31d",cex=2)
points(x=c(mstats1[2], mstats1[3]),y=c(-0.045,-0.045), type='l', lwd=4, col=scales::alpha("#009dc8",0.75))
points(x=mstats1[1],y=c(-0.045), pch=18,  col="#009dc8",cex=2)
# mtext(side=3,adj=0,text=paste0("Model5(1)","\n", "PC ~ Agri + env", "\n", "phylo-space"), line=-1, font=2)
