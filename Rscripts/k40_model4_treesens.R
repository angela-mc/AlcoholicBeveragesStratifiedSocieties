...
for(i in 1:ntrees){
  ...
  save(model4, file=paste0(outfol,"treesensitivity/model4/model4R_",i,".rds"))
  capture.output(summary(model4), file=paste0(outfol,"treesensitivity/model4/model4_summary_",i,".txt"))
}
#}, mc.cores=ncores)
